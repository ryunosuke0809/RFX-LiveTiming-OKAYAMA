...
export default function TimingPage() {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      {/* セッション切替タブ */}
      <div className="flex items-center gap-1 px-4 pl-14 py-1.5 bg-zinc-900/80 border-b border-zinc-800">
          ...
          {(["green", "yellow", "red", "fcy", "white", "chequered"] as TrackFlag[]).map((f) => (
            <button
              ...
              className={`w-5 h-5 rounded text-[8px] font-bold flex items-center justify-center transition-all ${
                sessionInfo.flag === f ? "ring-2 ring-white scale-110" : "opacity-60 hover:opacity-100"
              } ${
