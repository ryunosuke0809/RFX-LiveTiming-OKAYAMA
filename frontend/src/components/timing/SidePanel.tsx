    ...
    <>
      ...
      >
        <div className="p-2 space-y-1">
          <h3 className="text-[8px] uppercase tracking-widest text-zinc-500 font-semibold mb-1">
            Filter
          </h3>
          ...
          <div className="border-t border-zinc-700 pt-1 mt-1">
            <h4 className="text-[8px] uppercase tracking-widest text-zinc-500 font-semibold mb-1">
              Class
            </h4>
            {classes.map((cls) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left px-2 py-1 rounded text-[10px] font-medium transition-colors mb-0.5 flex items-center gap-1.5 ${
                    isActive
                      ? "bg-zinc-700 text-white"
                      : "text-zinc-400 hover:bg-zinc-800 hover:text-zinc-200"
                  }`}
