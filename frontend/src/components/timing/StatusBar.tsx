...
export default function StatusBar({ fastestLap, weather, trackCount }: StatusBarProps) {
  return (
    <footer
      className="flex items-center justify-between px-5 py-3 bg-zinc-900 border-t-2 border-zinc-700"
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-zinc-300" style={{ fontSize: "0.9em" }}>{fastestLap.driverName}</span>
        <span className="text-fuchsia-400 font-mono font-bold" style={{ fontSize: "1.1em" }}>
          {formatTime(fastestLap.lapTime)}
        </span>
        <span className="text-zinc-500" style={{ fontSize: "0.9em" }}>L{fastestLap.lap}</span>
        <div className="hidden md:flex items-center gap-2 ml-3 text-zinc-500" style={{ fontSize: "0.9em" }}>
          <span>S1</span>
      ...
      {/* WEATHER */}
      <div className="hidden lg:flex items-center gap-4 text-zinc-500" style={{ fontSize: "0.9em" }}>
